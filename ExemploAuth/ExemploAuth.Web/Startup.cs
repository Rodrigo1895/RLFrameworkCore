using ExemploAuth.Web.Middlewares;
    ...
    public class Startup : IStartup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAutenticacao(Configuration)
                ...
                {
                    options.AddJsonLocalizacaoArquivo(Constants.NomeErroSource, typeof(Constants).Assembly, "ExemploAuth.Web.Dominio.Localizacao.Arquivos");
        ...
        public void Configure(WebApplication app, IWebHostEnvironment environment)
        {
            ...
            var db = scope.ServiceProvider.GetRequiredService<AuthContexto>();
            db.Database.Migrate();
