...
{
    public class RabbitMqConsumerPedidoConcluidoEmail : RabbitMqConsumerBase<PedidoConcluidoMessage>
    {

        public RabbitMqConsumerPedidoConcluidoEmail(RabbitMqConnection rabbitMqConnection) : base(rabbitMqConnection)
        {
        }

        protected override string QueueName => "enviarEmailCliente";
