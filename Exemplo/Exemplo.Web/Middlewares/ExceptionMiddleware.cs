...
namespace Exemplo.Web.Middlewares
{
    public static class ExceptionMiddleware
    {
        ...
        private static async Task WriteResponse(HttpContext httpContext, bool includeDetails)
        {
            ...
            if (excecao != null)
            {
                ...
                ValidationProblemDetails erroResponse = new ValidationProblemDetails();
                erroResponse.Title = mensagem;
                erroResponse.Detail = detalhes;
                erroResponse.Status = StatusCodes.Status500InternalServerError;
